...
public class Sistema {
	   ...
	   ArrayList<Producto> productosFac = new ArrayList<Producto>();
	   String nom , ape, dir , tel , correo, cantidadProd, nombreProd;
	   int cantidad, codPro,codigo;
	   String [] nombre;
	   double precioProd, subTotal;
	   double total = 0;
	   Producto prod;
	   Cliente cliente;
       //while(!salir){
		...
		public void menu(){
			System.out.println( "Bienvenido al sistema de compras en linea");
			System.out.println( "");
